...
class ChsuApi:
    ...
    def get_professors_list(self):
        self.__base_headers["Authorization"] = f"Bearer {self.__get_new_token()}"
    ...
    def __get_new_token(self):
        ...
        return requests.post(self.__base_url + "/auth/signin", json=data, headers=self.__base_headers).json()["data"]
