...
class MongoDB:
    def __init__(self):
        self.__users_collection = pymongo.MongoClient(
            ...
            f"cluster-shard-00-02.rfoam.mongodb.net:27017/{MONGO_DB_NAME}?ssl=true&replica"
            f"Set=atlas-vnkwp2-shard-0&"
            f"authSource=admin&"
            f"retryWrites=true&"
            f"w=majority"
        )[MONGO_DB_NAME]["Users"]
    ...
    def set_user_data(self, user_id, university_id, role, api_name, mailing_time=None):
